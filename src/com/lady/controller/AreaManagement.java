...
/**
 * Servlet implementation class AreaManage
 */
@WebServlet("/AreaManagement")
public class AreaManagement extends HttpServlet {
...
//		FOR MySQL
		...
		request.setAttribute("areaInfo", list);
		request.getRequestDispatcher("admin3_manage.jsp").forward(request, response);
	}
