 ...
 */
@WebServlet("/ChangeAreaSession")
public class ChangeAreaSession extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ChangeAreaSession() {
        super();
...
//		FOR MySQL
		...
		request.getRequestDispatcher("TeamLeader").forward(request, response);;
	}
