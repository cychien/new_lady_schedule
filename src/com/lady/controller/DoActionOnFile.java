...
//                    System.out.println(bonus.size());
                        ...
                        for (int k = 0; k < workers.size(); k++) {
                            ...
                            //寫DB
                            Bonus bonus2 = new Bonus(workerId.get(k), workers.get(k), ConvertToLegalNumber.convertTo(month), (int)Math.round((bonus.get(j - 1)) * percent), 0, year);
                            bonusDAO.insertBonus(bonus2);
