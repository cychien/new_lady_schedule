...
@WebServlet("/UploadModifySalesPerformance")
public class UploadModifySalesPerformance  extends HttpServlet {
    private static final long serialVersionUID = 1L;

    public UploadModifySalesPerformance () {
        super();
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try{
            ...
            String currentFile = this.getServletContext().getRealPath("/Sales_Performance_Confirmed") + "/" + fileName;
            ...
            for(int i=0; i<name.size(); i++) {
                ...
                changeDataDAO.modifySalesPerformance(employeeId, calendar.get(Calendar.MONTH)+1, originMoney.get(i), percent.get(i), newMoney, calendar.get(Calendar.YEAR));
