...
@WebServlet("/UploadSalesPerformance")
public class UploadSalesPerformance extends HttpServlet {
    private static final long serialVersionUID = 1L;

//    private static final String UPLOAD_DIRECTORY = "upload";

    public UploadSalesPerformance() {
        super();
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        String savePath = this.getServletContext().getRealPath("/Sales_Performance_Upload");
        ...
        for (String fName : saveDir.list()) {
            if(fName.equals(fileName)) {
                repeat = true;
                request.setAttribute("isRepeat", "該月份業績表已上傳過，故無法再上傳");
                break;
            }
        }
        ...
        request.getRequestDispatcher("salesPerformance.jsp").forward(request, response);
    }
}
