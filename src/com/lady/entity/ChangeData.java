...
public class ChangeData {
    ...
    public ChangeData(int employeeId, int month, int year, int businessBonus, int targetBonus, int managementBonus, int yearBonus, int otherBonus, int supplementMinus, int chargeMinus, int violationMinus, int buyMinus, int phoneMinus, int checkMinus, int borrowMinus, int courtMinus, int otherMinus, int salesPerformance) {
